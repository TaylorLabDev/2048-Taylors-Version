...
var gameObj = {
    ...
    newBox: function () {
        ...
        var box = function (obj) {
            ...
            this.domObj = function () {
                ...
                textBox.innerText = num;
                textBox.textContent = num;
                textBox.className = 'textBox';
                domBox.appendChild(textBox);

                domBox.className = 'row' + obj.position[0] + ' ' + 'cell' + obj.position[1] + ' ' + 'num' + num + ' ' + 'cs';
    ...
    moveTo :function (obj1, obj2) {
            ...
            obj2.boxObj.domObj.className = 'row' + obj2.position[0] + ' ' + 'cell' + obj2.position[1] + ' ' + 'num' + obj2.boxObj.value  + ' ' + 'cs';
    ...
    addTo : function (obj1, obj2) {
            ...
            obj2.boxObj.domObj.children[0].innerText = obj2.boxObj.value;
            obj2.boxObj.domObj.children[0].textContent = obj2.boxObj.value;

            
            obj2.boxObj.domObj.classList.add("addTileStart");
            setTimeout(function(){ obj2.boxObj.domObj.classList.remove("addTileStart"); }, 10);

            this.points.score+=obj2.boxObj.value;
            if (this.points.score > this.points.best) {
                this.points.best = this.points.score;
                setCookie(this.points.best);
            }
        ...
        var bestBar= document.getElementById('best');
        bestBar.innerText=this.points.best;
        bestBar.textContent=this.points.best;
...
checkCookie();
gameObj.points.best = getCookie();


document.addEventListener('DOMContentLoaded', function() {
    var bestBar = document.getElementById('best');
    bestBar.innerText=gameObj.points.best;
    bestBar.textContent=gameObj.points.best;

    // get the element
    var div1 = document.getElementById('reload');
...
function setCookie(cvalue) {
    ...
    document.cookie = "best" + "=" + cvalue + ";" + expires + ";path=/";
  }
